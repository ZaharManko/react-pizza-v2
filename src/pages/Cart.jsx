            ...
            <div class="cart">
                <div class="cart__top">
                    ...
                    <div class="cart__clear">
                        ...
                        <span onClick={clearBuscetBtn}>Очистити корзину</span>
                    </div>
                </div>
                <div class="content__items">
                    ...
                    {cartData.map((item) => {
                        ...
                        return (<CartItem size={item.size} id={item.id} count={item.count} key={item.id} imageUrl={item.imageUrl} title={item.title} type={item.type} price={item.price} />)
                ...
                <div class="cart__bottom">
                    <div class="cart__bottom-details">
                        <span> Загалом піц: <b>{cartData.length} шт.</b> </span>
                        <span> Сумма замовлення: <b>{totalPrice} $</b> </span>
                    </div>
